                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
                            ...
                            <img src={person_2} alt="Image" className="img-fluid rounded-circle w-50 mb-5"/>
                            <h3>Lamine Sané</h3>
                        ...
                        <div className="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
                            <div className="person text-center">
                            <img src={person_3} alt="Image" className="img-fluid rounded-circle w-50 mb-5"/>
                        ...
                        <div className="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
                            <div className="person text-center">
                            <img src={person_4} alt="Image" className="img-fluid rounded-circle w-50 mb-5"/>
                            <h3>Cheikh Sall</h3>
